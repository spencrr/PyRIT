...
class FakeRuntime:
    ...
    def __init__(self) -> None:
        ...
        self.block = False
        self.fail = False
        self.history: list[TreeAssistantTurn] = []
    ...
    async def run_async(
        ...
        return AssistantRuntimeResult(reply="Pending human approval; nothing was applied.", proposal=tools.proposal)
...
def test_http_contract_missing_optional_sdk_and_validation() -> None:
    ...
    with (
        ...
        with TestClient(app) as client:
            ...
            huge = client.post("/api/tree-assistant/sessions", content=b"x" * 2_000_001)
