...
export const treeAssistantApi = {
  createSession: async (workspaceId: string): Promise<TreeAssistantSession> => {
    const response = await apiClient.post('/tree-assistant/sessions', { workspace_id: workspaceId })
